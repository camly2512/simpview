...
--
-- Host: localhost
-- Generation Time: Mar 14, 2024 at 04:08 PM
...
(10, 'Phát', 'Huỳnh', 'tanphat', 'CT06N0145@actvn.edu.vn', '335c40eafe26264a064ee40e95f7f25d', NULL, NULL, '1709004233_bia_chung.jpg', '1709004240_avt_145.png', 1, '2024-02-27 10:23:20', '2024-02-27 10:23:20', NULL, NULL),
(18, 'Quyền', 'Nguyễn', 'ducquyen', 'CT06N0151@actvn.edu.vn', 'cc4691b2eb405ebbf7e8a3080e0d466e', NULL, NULL, '1710424688_bia_chung.jpg', '1710424694_avt_151.png', 1, '2024-03-14 20:57:45', '2024-03-14 20:57:45', NULL, NULL);
...
CREATE TABLE `usersrp` (
  ...
  `user_id` int NOT NULL,
  `privacy` int NOT NULL DEFAULT '1',
  `report_reason` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
...
--
-- Dumping data for table `usersrp`
--
...
(36, 10, 2, 'SEVENTEEN (세븐틴) \'손오공\' Official MV', 'SEVENTEEN (세븐틴) \'손오공\' Official MV', 1, 'SEVENTEEN%20(세븐틴)%20\'손오공\'%20Official%20MV.mp4', 11, '2024-03-14 21:59:14', '2024-03-14 21:59:14', NULL, NULL);
...
--
-- Dumping data for table `videosrp`
--
...
--
ALTER TABLE `videos`
  MODIFY `video_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
